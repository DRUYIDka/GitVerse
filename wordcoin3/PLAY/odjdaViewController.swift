...
class odjdaViewController: UIViewController {
    ...
    var words = ["пальто","джинсы","шапка","шарф","платье","брюки","куртка","рубашка","шорты","кардиган","свитер","футболка","юбка","носки","пиджак","сапоги","туфли","пояс","перчатки","пижама","костюм","бикини","пальметто","джемпер","ремень","кепка","аксессуар","костюм","тапочки","плащ","ботинки","сарафан","толстовка","комбинезон"]
