...
class fiveletViewController: UIViewController {
    ...
    var words = ["акула", "белый", "горка", "дымок", "добро", "жираф", "жучок", "завод", "изгиб", "крыша", "лампа", "нищий", "обход", "отель", "юрист", "рулет", "текст", "уголь", "фикус", "халат", "цифра"]
