...
class ProfViewController: UIViewController {
    ...
    var words = ["врач","учитель","архитектор","шофер","пожарник","писатель","повар","юрист","модельер","механик","художник","фотограф","актёр","музыкант","строитель","бухгалтер","биолог","хирург","педиатр","фармацевт","танцор","ветеринар","режиссёр","полицейский","инженер","плотник","слесарь","пилот","астроном","психолог","дипломат","стилист","ювелир","бармен"]
