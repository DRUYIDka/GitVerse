...
class vecnaViewController: UIViewController {
    ...
    var words = ["весна", "первоцвет", "пасха", "расцвет", "природа", "озеленение", "тепло", "солнце", "цветение", "птицы", "бабочки", "пробуждение", "дождь", "пасмурно", "таяние", "апрель", "май", "веселый", "яркий", "прохлада", "зеленый"]
