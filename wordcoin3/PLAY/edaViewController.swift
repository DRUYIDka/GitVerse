...
class edaViewController: UIViewController {
    ...
    var words = ["пельмени","пицца","суши","бургер","салат","суп","рис","паста","стейк","шаурма","хлеб","омлет","фрукты","овощи","макароны","картофель","йогурт","мороженое","кекс","чипсы","фасоль","пирог","лапша","кукуруза","яйца","торт","шоколад","колбаса","сыр","мед","лимонад","печенье","гамбургер"]
